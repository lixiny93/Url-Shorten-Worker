let res
  function shorturl() {
	...
	document.getElementById("searchbtn").innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>客官请稍等...';
  ...
  console.log("使用 https://github.com/xyTom/Url-Shorten-Worker/ 制作 应用于cloudflare workers")
